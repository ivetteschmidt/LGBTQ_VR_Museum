...
namespace Pixyz.Toolbox.Editor
{
    ...
    public class CreateLightmapUVs : PixyzFunction
    {
        ...
        protected override void process()
        {
            ...
            NativeInterface.CreateProjectedUVs(Context.pixyzMeshes, false, 1, 0, false);
            ...
            foreach (uint mesh in uniqueMeshs)
            {
                ...
                NativeInterface.CreateProjectedUVs(meshList, false, 1, 1, true);
                UpdateProgressBar(0.65f, $"Creating lightMapUVs - Repack ({i}/{uniqueMeshs.Length})");
                NativeInterface.RepackUVs(meshList, 1, false, resolution, padding, false, 3, true);
