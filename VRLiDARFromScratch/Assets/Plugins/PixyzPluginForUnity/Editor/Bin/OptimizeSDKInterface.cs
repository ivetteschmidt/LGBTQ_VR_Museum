...
namespace Algo {
	...
	private static Polygonal.MeshDefinition_c ConvertValue(Polygonal.MeshDefinition s) {
		...
		[DllImport(PiXYZOptimizeSDK_dll)]
		private static extern void OptimizeSDK_createProjectedUVs(Polygonal.MeshList_c meshes, Int32 useLocalAABB, System.Double uv3dSize, Int32 channel, Int32 overrideExistingUVs);
		/// <summary>
		...
		public static void CreateProjectedUVs(Polygonal.MeshList meshes, Core.Bool useLocalAABB, Core.Double uv3dSize, Core.Int channel, Core.Bool overrideExistingUVs) {
			var meshes_c = ConvertValue(meshes);
			OptimizeSDK_createProjectedUVs(meshes_c, useLocalAABB ? 1 : 0, uv3dSize, channel, overrideExistingUVs ? 1 : 0);
			Polygonal_MeshList_free(ref meshes_c);
			System.String err = ConvertValue(OptimizeSDK_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
		...
		[DllImport(PiXYZOptimizeSDK_dll)]
		private static extern void OptimizeSDK_repackUVs(Polygonal.MeshList_c meshes, Int32 channel, Int32 shareMap, Int32 resolution, Int32 padding, Int32 uniformRatio, Int32 iterations, Int32 removeOverlaps);
		/// <summary>
		...
		public static void RepackUVs(Polygonal.MeshList meshes, Core.Int channel, Core.Bool shareMap, Core.Int resolution, Core.Int padding, Core.Bool uniformRatio, Core.Int iterations, Core.Bool removeOverlaps) {
			var meshes_c = ConvertValue(meshes);
			OptimizeSDK_repackUVs(meshes_c, channel, shareMap ? 1 : 0, resolution, padding, uniformRatio ? 1 : 0, iterations, removeOverlaps ? 1 : 0);
			Polygonal_MeshList_free(ref meshes_c);
			System.String err = ConvertValue(OptimizeSDK_getLastError());
			if(!System.String.IsNullOrEmpty(err))
				throw new Exception(err);
