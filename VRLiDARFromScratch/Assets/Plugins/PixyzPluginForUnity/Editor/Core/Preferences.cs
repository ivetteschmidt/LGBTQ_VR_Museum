...
namespace Pixyz.Plugin4Unity.Core
{
    internal class PreferencesProvider : SettingsProvider
    {
        ...
        public override void OnGUI(string searchContext)
        {
            ...
            Preferences.RecapSDKPath = EditorGUILayout.TextField("Recap SDK Path", Preferences.RecapSDKPath);
            ...
            //bool hasTokenUnityRuntime = Native.NativeInterface.IsTokenValid("UnityRuntime");
    ...
    public static class Preferences
    {
        ...
        public static string RecapSDKPath
        {
            get
            {
                return EditorPrefs.GetString("Pixyz_RecapSDKPath");
            }
            set
            {
                EditorPrefs.SetString("Pixyz_RecapSDKPath", value);
            }
        }
        ...
        public static string PluginLocation
        {
            get
            {
                string path = AssetDatabase.GUIDToAssetPath("7d7e9e8caa2f53446be7a94b30b8413c");
                path = path.Replace("README.md", string.Empty);
                return path;
            }
        }
        ...
        public static bool IncludeForRuntimeWindows
        {
            get
            {
                return EditorPrefs.GetBool("Pixyz_IncludeForRuntimeWindows", Native.NativeInterface.IsTokenValid("UnityRuntime"));
            }
